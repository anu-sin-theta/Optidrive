...
const FileExplorer = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const fetchFiles = async ()=>{
            try {
                const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`http://localhost:4000/file-explorer?path=${currentPath}`);
                setFiles([
    ...
    const handleDelete = async (file)=>{
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].delete(`http://localhost:4000/delete?path=${currentPath}/${file.name}`);
    ...
    const handleRename = async (file, newName)=>{
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post(`http://localhost:4000/rename`, {
                path: `${currentPath}/${file.name}`,
                newName
            });
            setFiles(files.map((f)=>f.name === file.name ? {
                    ...f,
                    name: newName
                } : f));
        } catch (error) {
    ...
    const renderFileIcon = (file)=>{
        ...
        if (imageExtensions.includes(file.extension)) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("img", {
                src: `http://localhost:4000/preview?path=${file.name}`,
                title: file.name,
                className: "thumbnail"
            }, void 0, false, {
    ...
    const handleMove = async (file, newPath)=>{
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post(`http://localhost:4000/move`, {
                path: `${currentPath}/${file.name}`,
                newPath
            });
            setFiles(files.filter((f)=>f.name !== file.name));
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: files.map((file)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                        className: `file-card ${file.isDirectory ? 'folder' : 'file'}`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                className: "file-icon",
                                onClick: ()=>handleFileClick(file),
                                children: file.isDirectory ? '📁' : renderFileIcon(file)
                            }, void 0, false, {
                                fileName: "[project]/src/pages/FileExplorer.js",
                                lineNumber: 93,
                                columnNumber: 13
                            ...
                            file.showMenu && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                className: "file-menu",
                                children: [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a3ba0a._.js.map